...
# ......
# if len(set(map(itemgetter(0), win))) == 1:
# ....# Horizontal
# elif len(set(map(itemgetter(1), win))) == 1:
# ....# Vertical
# else:
# ....# Diagonal
# -----------------------------------------
...
main()
# use module time to get current time and then you set variable
#
# end_pause = current + delay
#
# and later in loop you get again current time and
# compare with `end_pause`. This way you can control tasks using time.
# Some task can be skiped, other executed and it doesn't block `update()`
